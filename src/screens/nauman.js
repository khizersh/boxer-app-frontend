...
export default class ThumbnailExtractor extends Component {
  ...
  initScreenshot = () => {
    ...
    console.log("initScreenshot",this.videoDuration,this.videoInterval,this.videoStart)
  ...
  parseVideo = () => {
    ...
    console.log("parseVideo",this.props)
    ...
    console.log("parseVideo FILE URL",fileURL)
    ...
    console.log("parseVideo MID",this.props,videoHtml.duration)


    this.video.onloadedmetadata = () => {
        console.log("parseVideo onloadedmetadata",this.video)
    ...
    this.video.onplay = () => {
        console.log("parseVideo video.onplay",this.props)
      this.initScreenshot();
    };
    ...
    this.video.addEventListener('timeupdate', () => {
        console.log("parseVideo addEventListener",this.props)
    ...
    console.log("parseVideo END",this.props)


  };

  componentDidMount(prevProps, prevState) {
    console.log("Mount OUTSIDE")
    if (this.props.videoFile) {
        console.log("Mount INSIDE")
      this.parseVideo();
    }
  }
